...
#对得到的密集proposal,使用NMS来滤除多余的proposal
def proposal_layer(rpn_cls_prob_reshape, rpn_bbox_pred, im_info, cfg_key, _feat_stride=[16, ], anchor_scales=[16, ]):
    ...
    print('proposal_layer, rpn_cls_prob_reshape:', rpn_cls_prob_reshape.shape)
    print('proposal_layer, rpn_bbox_pred:', rpn_bbox_pred.shape)
